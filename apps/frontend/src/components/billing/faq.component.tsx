  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              `${branding.name || 'Postiz'} billing and charges`
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              `${branding.name || 'Postiz'} may place a temporary $2 authorization to confirm card information and release it immediately. You can cancel your subscription from settings.`
            ),
          },
        ]
      : []),
    {
      title: t(
        ...
        `Can I trust ${getGeneralBrandName(isGeneral)}?`
      ),
      description: t(
        'faq_postiz_gitroom_is_proudly_open_source',
        `${
          getGeneralBrandName(isGeneral)
