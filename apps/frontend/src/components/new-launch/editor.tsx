      ...
      {!canEdit && !isCreateSet && (
        <>
          ...
          >
            ...
            <div>
              <div className="text-[var(--brand-action-text)] rounded-full h-[44px] px-[20px] bg-[var(--brand-primary)] cursor-pointer flex justify-center items-center">
                        ...
                        {!!internal && !existingData?.integration && (
                          ...
                          >
                            <div className="flex gap-[6px] items-center">
                              <div className="w-[8px] h-[8px] rounded-full bg-[var(--brand-primary)]" />
