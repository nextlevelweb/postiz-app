    ...
    <div ref={ref} className="relative">
      <div
        ...
        className={clsx(
          ...
          currentDelay > 0 && 'bg-[var(--brand-primary)] text-[var(--brand-action-text,#fff)] rounded-full'
        )}
      >
        <DelayIcon />
      </div>
            ...
            {delayOptions.map((option) => (
              <div
                ...
                className={clsx(
                  ...
                  currentDelay === option.value && 'bg-[var(--brand-primary)] text-[var(--brand-action-text,#fff)] hover:bg-[var(--brand-primary)]'
                )}
              >
                {option.label}
              </div>
          ...
          <div className="border-t border-newTextColor/10 mt-[8px] pt-[8px]">
            <div className="flex gap-[4px]">
              <input
                ...
                className={clsx(
                  'flex-1 w-full h-[32px] px-[8px] rounded-[4px] bg-newBgColor border text-[13px] outline-none focus:border-[var(--brand-primary)]',
                  isCustomDelay ? 'border-[var(--brand-primary)]' : 'border-newTextColor/10'
                )}
              />
              <button
                onClick={(e) => {
                ...
                className="h-[32px] px-[12px] rounded-full bg-[var(--brand-primary)] text-[var(--brand-action-text,#fff)] text-[12px] font-[600]"
              >
                Set
              </button>
            </div>
