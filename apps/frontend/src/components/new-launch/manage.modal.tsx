...
export const ManageModal: FC<AddEditModalProps> = (props) => {
  ...
  return (
    <div className="w-full min-h-full xl:h-full flex-1 px-[8px] pt-[8px] pb-[100px] sm:px-[16px] sm:pt-[16px] sm:pb-[100px] xl:p-[40px] flex relative overflow-y-auto xl:overflow-hidden">
      <div className="flex flex-1 bg-newBgColorInner rounded-[20px] flex-col min-w-0">
        <div className="flex flex-col xl:flex-row flex-none xl:flex-1 min-w-0">
          <div className="flex flex-col flex-1 min-w-0 min-h-[560px] xl:min-h-0 border-b xl:border-b-0 xl:border-e border-newBorder">
            <div className="bg-newBgColor h-[65px] rounded-t-[20px] xl:rounded-t-none xl:rounded-s-[20px] xl:!rounded-b-[0] flex items-center gap-[12px] px-[20px] text-[20px] font-[600]">
              {t('create_post_title', 'Create Post')}
              <CreationMethodBadge
                creationMethod={existingData?.posts?.[0]?.creationMethod}
                size="sm"
              />
              <div className="ms-auto cursor-pointer xl:hidden">
            ...
            <div className="flex-1 flex flex-col gap-[16px]">
              ...
              >
                <div
                  id="social-content"
                  className="gap-[32px] flex flex-col px-[8px] sm:px-[20px] pt-[20px] absolute top-0 left-0 w-full h-full overflow-x-hidden overflow-y-scroll scrollbar scrollbar-thumb-newColColor scrollbar-track-newBgColorInner"
                >
              ...
              >
                <div className="flex-1 flex flex-col rounded-[12px] gap-[12px] overflow-hidden bg-newSettings">
                  <div
                    ...
                    className={clsx(
                      'w-full xl:w-fit xl:min-w-[280px] xl:max-w-[420px] bg-[var(--brand-primary)] text-[var(--brand-action-text)] rounded-full flex items-center gap-[8px] cursor-pointer px-[18px] py-[12px] font-[600]',
                      showSettings ? '!rounded-b-none' : ''
                    )}
                  >
                    <div className="flex-1 text-[14px] font-[600] text-[var(--brand-action-text)]">
          ...
          <div className="w-full xl:w-[580px] min-w-0 min-h-[360px] sm:min-h-[420px] xl:min-h-0 flex flex-col">
            <div className="bg-newBgColor h-[65px] rounded-none xl:rounded-e-[20px] xl:!rounded-b-[0] flex items-center px-[20px] text-[20px] font-[600]">
        ...
        <div className="select-none border-t border-newBorder flex flex-col xl:flex-row gap-[12px] p-[12px] sm:p-[20px] xl:py-[20px] xl:px-0">
          <div className="w-full xl:flex-1 flex flex-col sm:flex-row px-0 xl:ps-[20px] gap-[8px]">
            {!dummy && (
              <TagsComponent
                name="tags"
                label={t('tags', 'Tags')}
          ...
          <div className="w-full xl:w-auto px-0 xl:pe-[20px] grid grid-cols-1 sm:grid-cols-2 xl:flex items-stretch xl:items-center xl:justify-end gap-[8px]">
            {existingData?.integration && (
              <button
                onClick={deletePost}
            ...
            {!addEditSets && (
              <button
                ...
                className="relative cursor-pointer disabled:cursor-not-allowed px-[22px] h-[44px] w-full xl:w-auto bg-[var(--brand-primary)] text-[var(--brand-action-text)] justify-center items-center flex rounded-full text-[15px] font-[600]"
              >
                {loading && (
            ...
            {addEditSets && (
              <button
                className="text-white text-[15px] font-[600] w-full xl:w-auto xl:min-w-[180px] btnSub disabled:cursor-not-allowed disabled:opacity-80 outline-none gap-[8px] flex justify-center items-center h-[44px] rounded-full bg-[var(--brand-primary)] text-[var(--brand-action-text)] ps-[20px] pe-[16px]"
                disabled={
                  selectedIntegrations.length === 0 || loading || locked
                }
                onClick={schedule('draft')}
            ...
            {!addEditSets && (
              <div className="group cursor-pointer relative w-full xl:w-auto">
                <button
                  disabled={
                    selectedIntegrations.length === 0 || loading || locked
                  }
                  onClick={schedule('schedule')}
                  className="relative w-full xl:w-auto xl:min-w-[180px] btnSub disabled:cursor-not-allowed disabled:opacity-80 outline-none gap-[10px] flex justify-center items-center h-[44px] rounded-full bg-[var(--brand-secondary,#1B355F)] text-[var(--brand-text-light,#fff)] ps-[22px] pe-[16px] font-[600] hover:opacity-90 transition-opacity"
                >
                  {loading && (
                    <div className="absolute left-[50%] top-[50%] -translate-y-[50%] -translate-x-[50%]">
                ...
                {!dummy && (
                  ...
                  >
                    <div className="text-[var(--brand-action-text)] rounded-full bg-[var(--brand-primary)] h-[44px] w-full flex justify-center items-center post-now">
                      {t('post_now', 'Post Now')}
                    </div>
                  </button>
                )}
