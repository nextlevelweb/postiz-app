...
export const AddPostButton: FC<{
  ...
  return (
    <div className="flex">
      <div
        onClick={onClick}
        className="select-none cursor-pointer h-[34px] rounded-full flex bg-[var(--brand-primary)] gap-[8px] justify-center items-center pl-[16px] pr-[20px] text-[13px] font-[600] mt-[12px]"
      >
        <div>
          <svg
        ...
        <div className="!text-[var(--brand-action-text)]">
          {t(
