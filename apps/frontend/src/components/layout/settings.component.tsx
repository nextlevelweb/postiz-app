...
import { AgencyComponent } from '@gitroom/frontend/components/settings/agency.component';
export const SettingsPopup: FC<{
  ...
  const list = useMemo(() => {
    ...
    if (user?.role === 'SUPERADMIN') {
      arr.push({ tab: 'agency', label: t('agency', 'Agency') });
    }
        ...
        <FormProvider {...form}>
          <form onSubmit={form.handleSubmit(submit)}>
            ...
            >
              ...
              {tab === 'agency' && user?.role === 'SUPERADMIN' && (
                <div>
                  <AgencyComponent />
                </div>
              )}
